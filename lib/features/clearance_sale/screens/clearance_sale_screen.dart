...
import 'package:sixvalley_vendor_app/features/clearance_sale/widgets/show_confirmation_bottom_sheet_widget.dart';
                    ...
                    children: [
                      ...
                      FlutterSwitch(width: 40.0, height: 20.0, toggleSize: 18.0,
                        ...
                        onToggle: (bool isActive) async {
                          final clearanceController =
                          Provider.of<ClearanceSaleController>(context, listen: false);

                          if (isActive) {
                            if (clearanceController.clearanceConfigModel?.id == null) {
                            ...
                            showModalBottomSheet(context: context, builder: (ctx) => ShowConfirmationBottomSheetWidget(isActive: true));
                          }
                          else {
                            await clearanceController.updateConfigStatus(0);
                          }
                        },
                      )
                    ],
