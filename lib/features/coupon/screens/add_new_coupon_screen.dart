...
class _AddNewCouponScreenState extends State<AddNewCouponScreen> {
  ...
  void initState() {
    ...
    if (update) {
      ...
      discountAmountController.text = widget.coupons?.discountType == 'amount'
          ? PriceConverter.convertPriceWithoutSymbol(
              Get.context!,
              widget.coupons!.discount,
            )
          : widget.coupons!.discount.toString();
      minimumPurchaseController.text = PriceConverter.convertPriceWithoutSymbol(
        Get.context!,
        widget.coupons!.minPurchase,
      );
      limitController.text = widget.coupons!.limit.toString();
      maximumDiscountController.text = PriceConverter.convertPriceWithoutSymbol(
        Get.context!,
        widget.coupons!.maxDiscount,
      );
    ...
    Provider.of<CouponController>(
      context,
      listen: false,
    ).getCouponCustomerList(context, '');
    if (Provider.of<CouponController>(
          context,
          listen: false,
      ...
      Provider.of<CouponController>(
        context,
        listen: false,
      ).searchCustomerController.text = 'All Customer';
      Provider.of<CouponController>(
        context,
        listen: false,
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () => Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) =>
                                const CustomerSearchScreen(isCoupon: true),
                          ),
                        ),
                        child: Padding(
                      ...
                      coupon.selectedCouponType == 'discount_on_purchase'
                          ? CustomDropDownItemWidget(
                              ...
                              widget: DropdownButtonFormField<String>(
                                ...
                                items: coupon.discountTypeList.map((
                                  String value,
                                ) {
                                  return DropdownMenuItem<String>(
                                    value: value,
                      ...
                      if (coupon.discountTypeName == 'percentage')
                        const SizedBox(height: Dimensions.paddingSizeMedium),
                      if (coupon.selectedCouponType != 'free_delivery' &&
                        ...
                        children: [
                          Expanded(
                            child: CustomDatePickerWidget(
                              ...
                              selectDate: () =>
                                  coupon.selectDate("start", context),
                            ),
                          ),
                          ...
                          child: coupon.isAdd
                              ...
                              : CustomButtonWidget(
                                  ...
                                  onTap: () {
                                    ...
                                    int? customerId =
                                        coupon.selectedCustomerIdForCoupon;
                                    String couponTitle = couponTitleController
                                        .text
                                        .trim();
                                    String couponCode = couponCodeController
                                        .text
                                        .trim();
                                    ...
                                    if (couponTitle.isEmpty) {
                                      ...
                                      showCustomSnackBarWidget(
                                        getTranslated(
                                          'max_discount_is_required',
                                          context,
                                        ),
                                        context,
                                        sanckBarType: SnackBarType.warning,
                                      );
                                    } else if (coupon.startDate == null &&
                                        !update) {
                                      showCustomSnackBarWidget(
                                        getTranslated(
                                      ...
                                      showCustomSnackBarWidget(
                                        ...
                                        coupon.discountTypeName ==
                                            'percentage' &&
                                        double.parse(discountAmount) > 100) {
                                      showCustomSnackBarWidget(
                                        getTranslated(
                                          'discount_amount_should_be_less_then',
                                          context,
                                        ),
                                        context,
                                        sanckBarType: SnackBarType.warning,
                                        ...
                                        coupon.discountTypeName == 'amount' &&
                                        double.parse(
                                      ...
                                      showCustomSnackBarWidget(
                                        getTranslated(
                                          'minimum_purchase_amount_should_be_greater_than_the_discount_amount',
                                          context,
                                        ),
                                        context,
                                        sanckBarType: SnackBarType.warning,
