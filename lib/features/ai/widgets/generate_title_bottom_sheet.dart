                    ...
                    itemBuilder: (context, index) {
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          trailing: InkWell(
                            onTap: () async {
                              Provider.of<AddProductController>(context, listen: false).setTitle(widget.tabController!.index, aiController.titleSuggestionModel!.data!.titles![index], isUpdate: true);
