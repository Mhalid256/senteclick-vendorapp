              ...
              return GestureDetector(
                ...
                child: Stack(children: [
                            ...
                            borderRadius: BorderRadius.circular(Dimensions.radiusSmall)),
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  DiscountTagWidget(positionedTop: 5, positionedLeft: 5, positionedRight: 5) : const SizedBox(),


                                  if ((widget.productModel.currentStock ?? 0) <= 0)
                  ...
                  (widget.productModel.variation!.isNotEmpty || widget.productModel.digitalProductFileTypes!.isNotEmpty)?
                    Positioned(
                      right:  Provider.of<LocalizationController>(context, listen: false).isLtr? 10 : null, bottom: 5, left:  Provider.of<LocalizationController>(context, listen: false).isLtr?  null : 10,
                      child: Align(
                              ...
                              InkWell(
                                onTap: () {
                                  if((widget.productModel.currentStock ?? 0) >= 1) {
                                    ...
                                    showCustomSnackBarWidget(getTranslated('out_of_stock', context), context, isToaster: true, sanckBarType : SnackBarType.warning);
                                  }
                                },
                                child: Icon(Icons.add_circle, color: Theme.of(context). primaryColor,size: Dimensions.incrementButton),
                              ),
