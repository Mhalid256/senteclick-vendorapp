...
import '../../product/widgets/top_most_product_card_widget.dart';
...
class CartBottomSheetWidgetState extends State<CartBottomSheetWidget> {
  ...
  void initState() {
    ...
    Provider.of<ProductController>(context, listen: false)
        .updateQuantity(true, isUpdate: false);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Column(mainAxisSize: MainAxisSize.min, children: [
      Container(
        ...
        child: Consumer<CartController>(builder: (ctx, cartController, child) {
          return Consumer<ProductController>(
            builder: (ctx, productProvider, child) {
              ...
              int isUpdate = getIsExistInCart(cartController.currentCartModel,
                  widget.product!, variationType, variantKey);
              ...
              double priceWithDiscount = PriceConverter.convertWithDiscount(context, price,
                  widget.product?.clearanceSale != null ? widget.product!.clearanceSale!.discountAmount : widget.product!.discount,
                  widget.product?.clearanceSale != null ? widget.product!.clearanceSale!.discountType : widget.product!.discountType)!;
                  ...
                  children: [
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                boxShadow: [
                                  BoxShadow(
                                    color: Provider.of<ThemeController>(context, listen: false).darkTheme ? Theme.of(context).cardColor : Theme.of(context).hintColor,
                                    spreadRadius: 1,
                                    blurRadius: 5,
                                  )
                                ]),
                    ...
                    Padding(
                      ...
                      child: Stack(children: [
                              ...
                              Expanded(
                                ...
                                children: [
                                  ...
                                  Row(
                                      mainAxisAlignment: MainAxisAlignment.start,
                                      children: [
                                        // if (widget.product!.discount! > 0 || (widget.product?.clearanceSale != null && widget.product!.clearanceSale!.discountAmount! > 0)) ...[
                                        //   Container(
                                        ...
                                        if (widget.product!.discount! > 0 || (widget.product?.clearanceSale != null && widget.product!.clearanceSale!.discountAmount! > 0)) ...[
                                          Text(PriceConverter.convertPrice(context, price),
                                            style: titilliumRegular.copyWith(color: Theme.of(context).colorScheme.error, decoration: TextDecoration.lineThrough)),
                                          const SizedBox(width: Dimensions.paddingSizeDefault),
                                        ],

                                        Text(PriceConverter.convertPrice(context, price,
                                          discountType: widget.product?.clearanceSale != null ? widget.product!.clearanceSale!.discountType : widget.product!.discountType,
                                          discount: widget.product?.clearanceSale != null ? widget.product!.clearanceSale!.discountAmount : widget.product!.discount),
                                          style: titilliumRegular.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeExtraLarge)
                                        ),
                        ...
                        widget.product != null && widget.product!.discount != null && ((widget.product!.discount! > 0) || (widget.product?.clearanceSale?.discountAmount ?? 0) > 0)
                          ? DiscountTagWidget(productModel: widget.product!, positionedTop: 0, topLeftBorderRadius: Dimensions.radiusDefault, bottomRightBorderRadius: Dimensions.radiusDefault)
                                    ...
                                    Expanded(
                                      child: GridView.builder(
                                        ...
                                        gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                                          ...
                                          mainAxisSpacing: 5,
                                          crossAxisSpacing: 2,
                                          childAspectRatio: 1.3, // square cells
                                        ),
                                        itemBuilder: (ctx, index) {
                                          ...
                                          return InkWell(
                                            ...
                                            child: Container(padding: const EdgeInsets.all(1), // smaller padding
                                              decoration: BoxDecoration(
                                                shape: BoxShape.circle,
                                                border: productProvider.variantIndex == index
                                                  ? Border.all(width: 2, color: Theme.of(context).primaryColor)
                                                  : Border.all(width: 2, color: Theme.of(context).hintColor.withAlpha(60)),
                                              ),
                                              child: Container(height: 25, width: 25,
                                                decoration: BoxDecoration(shape: BoxShape.circle, color: Color(int.parse(colorString))),
                                              ),
                                            ),
                                          );
                                        },
                                          ...
                                          children: [
                                            ...
                                            Expanded(
                                              child: Wrap(spacing: 8, runSpacing: 8,
                                                children: List.generate(choice.options!.length,
                                                (i) {
                                                  ...
                                                  return InkWell(
                                                    onTap: () {
                                                      Provider.of<ProductController>(context, listen: false).setCartVariationIndex(widget.product!.minimumOrderQty, index, i, context);
                                                    },
                                                    child: Container(
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: GridView.builder(
                                    ...
                                    itemBuilder: (ctx, i) {
                                      bool isSelect = (productProvider
                                                  .digitalVariationIndex ==
                                              index &&
                                          productProvider
                                                  .digitalVariationSubindex ==
                                              i);
                                      return InkWell(
                                        splashColor: Colors.transparent,
                                        onTap: () =>
                    ...
                    Row(children: [
                      ...
                      QuantityButton(
                          disable: productProvider.quantity == 1,
                          isIncrement: false,
  ...
  int getIsExistInCart(TemporaryCartListModel? currentCartModel,
      Product product, String variantKey, String? digitalVariantKey) {
    int index = -1;

    for (int i = 0; i < (currentCartModel?.cart?.length ?? 0); i++) {
      if (currentCartModel?.cart![i].product!.id == product.id &&
          (variantKey == '' && digitalVariantKey == null)) {
        index = i;
        return i;
      } else if (currentCartModel?.cart![i].product!.id == product.id &&
          (variantKey != '' || digitalVariantKey != null)) {
        String cartVariantKey = getVariantKey(currentCartModel!.cart![i]);

        if (cartVariantKey == variantKey ||
            cartVariantKey == digitalVariantKey) {
          index = i;
          return index;
        }
      }
