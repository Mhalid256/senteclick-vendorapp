...
class _ReviewFilterBottomSheetWidgetState
  ...
  @override
  void initState() {
    Provider.of<ProductReviewController>(
      Get.context!,
      listen: false,
    ).setAllFieldSelected(true, isUpdate: false);
    super.initState();
  }
                  ...
                  children: [
                    ...
                    CustomDropDownItemWidget(
                      widget: DropdownButtonFormField<String>(
                        ...
                        style: robotoRegular,
                        onChanged: (value) {
                          reviewProvider.setReviewStatusIndex(
                            value == 'select_status'
                                ? 0
                                : value == 'active'
                                ? 1
                        ...
                        children: [
                          ...
                          Expanded(
                            child: CustomButtonWidget(
                              ...
                              onTap: () {
                                if (reviewProvider.startDate == null &&
                                    reviewProvider.endDate == null &&
                                    reviewProvider.reviewStatusIndex == 0 &&
                                ...
                                } else if ((reviewProvider.startDate != null &&
                                        reviewProvider.endDate == null) ||
                                    (reviewProvider.startDate == null &&
                                        reviewProvider.endDate != null)) {
                                  showCustomToast(
                                    message: getTranslated(
                                    ...
                                    reviewProvider.endDate != null &&
                                    !isEndDateValid(
                                      reviewProvider.startDate!,
                                      reviewProvider.endDate!,
                                    )) {
                                  showCustomToast(
                                    message: getTranslated(
                                      'end_date_should_not_before_start_date',
                                      context,
                                    )!,
                                    context: context,
                                    isSuccess: false,
                                  ...
                                  String selectedCustomerId = customerId == 0
                                      ? 'all'
                                      : customerId.toString();
