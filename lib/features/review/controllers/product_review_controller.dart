...
class ProductReviewController extends ChangeNotifier{
  ...
  Future<void> filterReviewList(BuildContext context, int? productId, String? customerId) async {
    _isLoading = true;
    notifyListeners();
  ...
  void resetReviewData({bool isUpdate = true}) {
    ...
    Provider.of<CustomerController>(Get.context!, listen: false).resetCustomerId(isUpdate: false, customerId: 0);
