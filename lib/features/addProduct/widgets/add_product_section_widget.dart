...
class AddProductSectionWidget extends StatelessWidget {
  ...
  const AddProductSectionWidget({super.key, this.title, required this.childrens, this.titleStyle, this.isDecoration = true, this.aiWidget, this.isAiGenerating, this.childrenPadding, this.subTitle, this.button, this.isRequired = false});
