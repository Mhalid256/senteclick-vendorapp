    ...
    for(int i=0; i<length; i++) {
      ...
      if(product != null && genereateVariation == null) {
        ...
        if (genereateVariation != null) {
          ...
          _variantTypeList.add(VariantTypeModel(variantType: value,
            controller: TextEditingController(text: Provider.of<AddProductController>(context,listen: false).unitPriceController.text), node: FocusNode(),
            qtyController: TextEditingController(text: '1'),qtyNode: FocusNode())
          );
        }
      }
