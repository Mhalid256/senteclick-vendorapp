      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
                    ...
                    ClipRRect(
                      ...
                      child: SizedBox(
                        ...
                        child: CustomImageWidget(
                          image: "${reviewModel.customer?.imageFullUrl?.path}",
                        ),
                      ),
                    ),
                  ...
                  Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          reviewModel.orderId != null
                              ? Text(
                                  '${getTranslated('order', context)!}#${reviewModel.orderId}',
                                  style: robotoMedium.copyWith(
                                    color: Theme.of(
                                      context,
                                    ).textTheme.bodyLarge?.color,
                      ...
                      reviewModel.createdAt != null
                          ? Text(
                              DateConverter.formatTimeDateShort(
            ...
            (reviewModel.comment != null && reviewModel.comment!.isNotEmpty)
                ? Padding(
                    ...
                    child: ReadMoreText(
                      ...
                      trimExpandedText:
                          ' ${getTranslated('view_less', context)!}',
                      delimiter: ' ... ',
            ...
            (reviewModel.attachmentFullUrl != null &&
                    reviewModel.attachmentFullUrl!.isNotEmpty)
                ? Padding(
                    padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
                    child: SizedBox(
                      height: 45,
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          String imageUrl =
                              '${reviewModel.attachmentFullUrl![index].path}';
                          return InkWell(
                            onTap: () => showDialog(
                              context: context,
                              builder: (ctx) =>
