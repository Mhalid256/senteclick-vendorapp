  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
        ...
        Consumer<RefundController>(
          builder: (context,refundReq,_) {
          return (refundReq.refundDetailsModel!.refundRequest![0].refundStatus == null ||
            refundReq.refundDetailsModel!.refundRequest![0].refundStatus!.isEmpty ||
            refundReq.refundDetailsModel!.refundRequest![0].refundStatus!.last.changeBy != 'admin')
              ? ApprovedAndRejectWidget(refundModel: widget.refundModel, orderDetailsId: widget.orderDetailsId) : const SizedBox();
          }
        ),
